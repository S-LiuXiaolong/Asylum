...
// helper macros
#define TITLE				"Variance shadow mapping"
...
bool InitScene()
{
	...
	if (!GLCreateMeshFromQM("../../../Asset/Mesh/QM/box.qm", &table)) {
		MYERROR("Could not load 'box'");
		return false;
	}

	if (!GLCreateMeshFromQM("../../../Asset/Mesh/QM/angel.qm", &angel)) {
	...
	// load textures
	const char* files[6] = {
		"../../../Asset/Textures/cubemap1_posx.jpg",
		"../../../Asset/Textures/cubemap1_negx.jpg",
		"../../../Asset/Textures/cubemap1_posy.jpg",
		"../../../Asset/Textures/cubemap1_negy.jpg",
		"../../../Asset/Textures/cubemap1_posz.jpg",
		"../../../Asset/Textures/cubemap1_negz.jpg"
	};

	GLCreateCubeTextureFromFiles(files, true, &environment);
	GLCreateTextureFromFile("../../../Asset/Textures/burloak.jpg", true, &wood);
	...
	if (!GLCreateEffectFromFile("../../../Asset/Shaders/GLSL/screenquad.vert", 0, 0, 0, "../../../Asset/Shaders/GLSL/bloomcombine.frag", &bloom)) {
		MYERROR("Could not load 'bloom' shader");
		return false;
	}

	if (!GLCreateEffectFromFile("../../../Asset/Shaders/GLSL/shadowmap_variance.vert", 0, 0, 0, "../../../Asset/Shaders/GLSL/shadowmap_variance.frag", &varianceshadow)) {
		MYERROR("Could not load 'shadowmap' shader");
		return false;
	}

	if (!GLCreateEffectFromFile("../../../Asset/Shaders/GLSL/blinnphong_variance.vert", 0, 0, 0, "../../../Asset/Shaders/GLSL/blinnphong_variance.frag", &blinnphong)) {
		MYERROR("Could not load 'blinnphong' shader");
		return false;
	}

	if (!GLCreateEffectFromFile("../../../Asset/Shaders/GLSL/screenquad.vert", 0, 0, 0, "../../../Asset/Shaders/GLSL/boxblur3x3.frag", &boxblur3x3)) {
